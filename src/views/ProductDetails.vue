        ...
        <div class="col-md-6 border-end">
          <div class="d-flex flex-column justify-content-center">
            <div class="main_image">
              <img :src="product.image" id="main_product_image" wiGBPh="350" />
            </div>
            ...
            <div class="mt-5">
              <div class="r" style="display: flex; margin: auto">
                ...
                <img
                  ...
                  style="margin-left: 15px; wiGBPh: 23px"
                />
    ...
    <div class="modal-dialog">
      <div class="modal-content" style="border: black">
        ...
        <div class="modal-body" style="display: flex">
          <div class="card mb-3" style="max-wiGBPh: 540px">
            <div class="row g-0">
              <div class="col-md-4">
                <img
                  :src="product.image"
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <br />
                  <h6 class="card-text">Price : {{ product.price }} GBP</h6>
                  <p class="card-text">
