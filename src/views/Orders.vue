<template>
  <div class="container">
    ...
    <table class="table table-bordered" v-if="orders.length > 0">
      <thead style="background: #5C2751; color: white">
        <tr>
          <!-- <th scope="col"></th> -->
    ...
    >
      ...
      <div>
        ...
        <a style="wiGBPh: auto"> Continue shopping </a>
      </div>
    </div>
    <!-- Modal 3 (delete) -->
    <div
              ...
              <div class="col-md-12">
                <div class="invoice">
                  ...
                  <div class="row align-items-start">
                    <div class="col">Soch Blooms Limited</div>
                  </div>
                  <!-- end invoice-company -->
                  ...
                  <div class="invoice-header">
                    <div class="invoice-from">
                      ...
                      <address class="m-t-5 m-b-5">
                        <strong class="text-inverse">Soch Blooms Limited</strong><br />
                        Address: East London<br />
                        Phone: 07301213935
                      </address>
                    </div>
                  ...
                  <div class="invoice-content">
                    ...
                    <div class="table-responsive">
                      <table class="table table-invoice">
                        <thead>
                          <tr>
                            <th>PRODUCTS</th>
                            <th class="text-center" wiGBPh="10%">RATE</th>
                            <th class="text-center" wiGBPh="10%">QUANTITY</th>
                            <th class="text-right" wiGBPh="20%">LINE TOTAL</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr v-for="item in productdata.cart" :key="item.name">
                            ...
                            <td class="text-center">{{ item.price }} GBP</td>
                            <td class="text-center">{{ item.quantity }}</td>
                            <td class="text-right">{{ item.totalPrice }} GBP</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    ...
                    <div class="invoice-price">
                      ...
                      <div class="invoice-price-right">
                        <small>TOTAL</small>
                        <span class="f-w-600">{{ productdata.total - 5 }} GBP</span>
                      </div>
                    </div>
                    <!-- end invoice-price -->
                  </div>
                  ...
                  <div class="invoice-note">
                    * Make all cheques payable to Sochblooms<br />
                    * Payment is due within 3 Days<br />
